...
var crawlerExclusions = ['gif', 'jpg', 'jpeg', 'png', 'ico', 'bmp', 'ogg', 'webp',
    ...
    'rar', '7z', 'css', 'js', 'gzip', 'exe', 'svg', 'pptx', 'cdn-cgi', 'xmlrpc', 'wp-comments-post', 'oft'
];
...
var Crawler = function(options) {
    ...
    if (this.sitecrawlerOptions.cache){
        // cache results
    ...
    if (Array.isArray(this.sitecrawlerOptions.exclude) && this.sitecrawlerOptions.exclude.length > 0) {
        crawlerExclusions = crawlerExclusions.concat(this.sitecrawlerOptions.exclude);
    }
