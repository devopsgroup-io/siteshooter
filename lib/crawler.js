...
function writeCollections(collectionName, collection) {
...
Crawler.prototype.crawlHost = function() {
    ...
    if ( this.options.uri.host.indexOf('visual.force') > -1 ) {
        ...
        this.crawler.on('complete', function() {
            ...
            sitemap.writeXML(this.sitemapLinks, function(err) {
                ...
                if (err) {
                    ...
                    return utils.executeWhen(error.collector404.length > 0, function() {
                        ...
                        utils.log.log(utils.log.chalk.red.bold('   ✗ 404 errors:'), utils.log.chalk.red(error.collector404.length));

                        return writeCollections('urls_404.json', error.collector404);
                    })
