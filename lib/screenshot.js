...
var renderUrlsToFile = function(ph, options, urls, callbackPerUrl, callbackFinal) {
    ...
    var authSalesforce, collectWebsiteInformation, getFileName, getDocumentReadyState, getUserAgent, nextPage, retrievePage, renderViewPort, waitFor;
        ...
        setTimeout(function() {
            ...
            page.evaluate(function(user, password) {
                ...
                if (hostName.indexOf('.microsoftonline.com') > -1) {
                    ...
                    document.getElementById("cred_password_inputtext").value = password;
    ...
    collectWebsiteInformation = function(page, url) {
        ...
        return utils.executeWhen(!pageExists, function() {
            ...
            return page.evaluate(function() {
                ...
                data.pageStatus = document.readyState;
            ...
            waitFor(function() {
                ...
                return collectWebsiteInformation(page, url)
                    ...
                    .then(function() {
                        ...
                        return page.injectJs('inject.js');

                    })
                    .then(function(status) {
                        utils.log.verbose('Injected inject.js file', status);
                    })
                    .then(function() {

                        setTimeout(function() {

                            utils.log.verbose('Rendering page with a set delay of', options.screenshot_options.delay);
        ...
        if (urls.length > 0) {
            ...
            ph.createPage().then(function(page) {
                ...
                page.on('onLoadFinished', function(pageStatus) {
                    ...
                    // check for Salesforce parts in URL
                    } else if (url.indexOf('.sharepoint.com') > -1 && !isLoggedIn) {
...
Screenshot.prototype.start = function() {
    ...
    phantom.create(phantomOptions).then(function(ph) {
        ...
        return globby([path.join(options.paths.output, '**', '*.png')])
            .then(function(paths) {
                ...
                return utils.writeFile('.siteshooter/content-collection.json', JSON.stringify(contentCollection));
