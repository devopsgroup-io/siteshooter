...
function renderPage(options, url, done) {
    ...
    phantom.create(phantomOptions).then(function(ph) {
        ...
        ph.createPage().then(function(page) {
            ...
            page.setting('userAgent', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/56.0.2924.87 Safari/537.36');
